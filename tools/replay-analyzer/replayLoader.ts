...
export async function loadReplay(opts: {
  ...
  const parsedGame = opts.openfront.Schemas.GameRecordSchema.safeParse(json);
  const parsedPartial = opts.openfront.Schemas.PartialGameRecordSchema.safeParse(json);
